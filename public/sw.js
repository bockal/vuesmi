const CACHE="the-vues-shell-v6";
const SHELL=["/","/manifest.webmanifest","/vues-farm-bell.svg","/vues-farm-bell-192.png","/vues-farm-bell-512.png","/apple-touch-icon.png"];
...
self.addEventListener("push",event=>{
  ...
  event.waitUntil(self.registration.showNotification(data.title||"New Vues booking request",{body:data.body||"Open the owner portal to review it.",icon:"/vues-farm-bell-192.png",badge:"/vues-farm-bell-192.png",data:{url:data.url||"/owner"},tag:data.tag||"vues-booking"}));
});
